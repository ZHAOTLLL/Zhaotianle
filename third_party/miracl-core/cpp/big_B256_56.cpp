...
chunk B256_56::BIG_cmove(volatile BIG f, BIG g, int d)
{
    int i;
...
chunk B256_56::BIG_cswap(volatile BIG f, volatile BIG g, int d)
{
    int i;
...
chunk B256_56::BIG_dcmove(volatile DBIG f, DBIG g, int d)
{
    int i;
    chunk c0,c1,s,t,w,aux;
    static chunk R=0;
...
//B256_56::BIGMULS++;
	...
	s=d[0];
	t = s; c[0]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56;
	s+=d[1]; t=co+s +(dchunk)(a[1]-a[0])*(b[0]-b[1]); c[1]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s+=d[2]; t=co+s +(dchunk)(a[2]-a[0])*(b[0]-b[2]); c[2]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s+=d[3]; t=co+s +(dchunk)(a[3]-a[0])*(b[0]-b[3])+(dchunk)(a[2]-a[1])*(b[1]-b[2]); c[3]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s+=d[4]; t=co+s +(dchunk)(a[4]-a[0])*(b[0]-b[4])+(dchunk)(a[3]-a[1])*(b[1]-b[3]); c[4]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s+=d[5]; t=co+s +(dchunk)(a[5]-a[0])*(b[0]-b[5])+(dchunk)(a[4]-a[1])*(b[1]-b[4])+(dchunk)(a[3]-a[2])*(b[2]-b[3]); c[5]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s+=d[6]; t=co+s +(dchunk)(a[6]-a[0])*(b[0]-b[6])+(dchunk)(a[5]-a[1])*(b[1]-b[5])+(dchunk)(a[4]-a[2])*(b[2]-b[4]); c[6]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 

	s-=d[0]; t=co+s +(dchunk)(a[6]-a[1])*(b[1]-b[6])+(dchunk)(a[5]-a[2])*(b[2]-b[5])+(dchunk)(a[4]-a[3])*(b[3]-b[4]); c[7]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s-=d[1]; t=co+s +(dchunk)(a[6]-a[2])*(b[2]-b[6])+(dchunk)(a[5]-a[3])*(b[3]-b[5]); c[8]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s-=d[2]; t=co+s +(dchunk)(a[6]-a[3])*(b[3]-b[6])+(dchunk)(a[5]-a[4])*(b[4]-b[5]); c[9]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s-=d[3]; t=co+s +(dchunk)(a[6]-a[4])*(b[4]-b[6]); c[10]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s-=d[4]; t=co+s +(dchunk)(a[6]-a[5])*(b[5]-b[6]); c[11]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	s-=d[5]; t=co+s ; c[12]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	c[13]=(chunk)co;


#else

    	t=(dchunk)a[0]*b[0]; c[0]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[0]*b[1]+(dchunk)a[1]*b[0]; c[1]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[0]*b[2]+(dchunk)a[1]*b[1]+(dchunk)a[2]*b[0]; c[2]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[0]*b[3]+(dchunk)a[1]*b[2]+(dchunk)a[2]*b[1]+(dchunk)a[3]*b[0]; c[3]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[0]*b[4]+(dchunk)a[1]*b[3]+(dchunk)a[2]*b[2]+(dchunk)a[3]*b[1]+(dchunk)a[4]*b[0]; c[4]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[0]*b[5]+(dchunk)a[1]*b[4]+(dchunk)a[2]*b[3]+(dchunk)a[3]*b[2]+(dchunk)a[4]*b[1]+(dchunk)a[5]*b[0]; c[5]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[0]*b[6]+(dchunk)a[1]*b[5]+(dchunk)a[2]*b[4]+(dchunk)a[3]*b[3]+(dchunk)a[4]*b[2]+(dchunk)a[5]*b[1]+(dchunk)a[6]*b[0]; c[6]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[1]*b[6]+(dchunk)a[2]*b[5]+(dchunk)a[3]*b[4]+(dchunk)a[4]*b[3]+(dchunk)a[5]*b[2]+(dchunk)a[6]*b[1]; c[7]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[2]*b[6]+(dchunk)a[3]*b[5]+(dchunk)a[4]*b[4]+(dchunk)a[5]*b[3]+(dchunk)a[6]*b[2]; c[8]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[3]*b[6]+(dchunk)a[4]*b[5]+(dchunk)a[5]*b[4]+(dchunk)a[6]*b[3]; c[9]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[4]*b[6]+(dchunk)a[5]*b[5]+(dchunk)a[6]*b[4]; c[10]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[5]*b[6]+(dchunk)a[6]*b[5]; c[11]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	t=t+(dchunk)a[6]*b[6]; c[12]=(chunk)t & BMASK_B256_56; t=t>>BASEBITS_B256_56;
	c[13]=(chunk)t;
...
//B256_56::BIGSQRS++;
	...
	t=(dchunk)a[0]*a[0]; c[0]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56;
	t= +(dchunk)a[1]*a[0]; t+=t; t+=co; c[1]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[2]*a[0]; t+=t; t+=co; t+=(dchunk)a[1]*a[1]; c[2]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[3]*a[0]+(dchunk)a[2]*a[1]; t+=t; t+=co; c[3]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[4]*a[0]+(dchunk)a[3]*a[1]; t+=t; t+=co; t+=(dchunk)a[2]*a[2]; c[4]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[5]*a[0]+(dchunk)a[4]*a[1]+(dchunk)a[3]*a[2]; t+=t; t+=co; c[5]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[6]*a[0]+(dchunk)a[5]*a[1]+(dchunk)a[4]*a[2]; t+=t; t+=co; t+=(dchunk)a[3]*a[3]; c[6]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 

	t= +(dchunk)a[6]*a[1]+(dchunk)a[5]*a[2]+(dchunk)a[4]*a[3]; t+=t; t+=co; c[7]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[6]*a[2]+(dchunk)a[5]*a[3]; t+=t; t+=co; t+=(dchunk)a[4]*a[4]; c[8]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[6]*a[3]+(dchunk)a[5]*a[4]; t+=t; t+=co; c[9]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[6]*a[4]; t+=t; t+=co; t+=(dchunk)a[5]*a[5]; c[10]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t= +(dchunk)a[6]*a[5]; t+=t; t+=co; c[11]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
	t=co; t+=(dchunk)a[6]*a[6]; c[12]=(chunk)t&BMASK_B256_56; co=t>>BASEBITS_B256_56; 
 	c[13]=(chunk)co;
...
void B256_56::BIG_monty(BIG a, BIG md, chunk MC, DBIG d)
{
    ...
    if ((d[DMPV_B256_56] != 1 && d[DMPV_B256_56] != 0) || d[DMNV_B256_56] != 0) printf("Input to redc not normed\n");
    	...
    	t=d[0]; v[0]=((chunk)t*MC)&BMASK_B256_56; t+=(dchunk)v[0]*md[0];  s=0; c=(t>>BASEBITS_B256_56);

	t=d[1]+c+s+(dchunk)v[0]*md[1]; v[1]=((chunk)t*MC)&BMASK_B256_56; t+=(dchunk)v[1]*md[0];  dd[1]=(dchunk)v[1]*md[1]; s+=dd[1]; c=(t>>BASEBITS_B256_56); 
	t=d[2]+c+s+(dchunk)v[0]*md[2]; v[2]=((chunk)t*MC)&BMASK_B256_56; t+=(dchunk)v[2]*md[0];  dd[2]=(dchunk)v[2]*md[2]; s+=dd[2]; c=(t>>BASEBITS_B256_56); 
	t=d[3]+c+s+(dchunk)v[0]*md[3]+(dchunk)(v[1]-v[2])*(md[2]-md[1]); v[3]=((chunk)t*MC)&BMASK_B256_56; t+=(dchunk)v[3]*md[0];  dd[3]=(dchunk)v[3]*md[3]; s+=dd[3]; c=(t>>BASEBITS_B256_56); 
	t=d[4]+c+s+(dchunk)v[0]*md[4]+(dchunk)(v[1]-v[3])*(md[3]-md[1]); v[4]=((chunk)t*MC)&BMASK_B256_56; t+=(dchunk)v[4]*md[0];  dd[4]=(dchunk)v[4]*md[4]; s+=dd[4]; c=(t>>BASEBITS_B256_56); 
	t=d[5]+c+s+(dchunk)v[0]*md[5]+(dchunk)(v[1]-v[4])*(md[4]-md[1])+(dchunk)(v[2]-v[3])*(md[3]-md[2]); v[5]=((chunk)t*MC)&BMASK_B256_56; t+=(dchunk)v[5]*md[0];  dd[5]=(dchunk)v[5]*md[5]; s+=dd[5]; c=(t>>BASEBITS_B256_56); 
	t=d[6]+c+s+(dchunk)v[0]*md[6]+(dchunk)(v[1]-v[5])*(md[5]-md[1])+(dchunk)(v[2]-v[4])*(md[4]-md[2]); v[6]=((chunk)t*MC)&BMASK_B256_56; t+=(dchunk)v[6]*md[0];  dd[6]=(dchunk)v[6]*md[6]; s+=dd[6]; c=(t>>BASEBITS_B256_56); 

	t=d[7]+c+s+(dchunk)(v[1]-v[6])*(md[6]-md[1])+(dchunk)(v[2]-v[5])*(md[5]-md[2])+(dchunk)(v[3]-v[4])*(md[4]-md[3]); a[0]=(chunk)t&BMASK_B256_56;  s-=dd[1]; c=(t>>BASEBITS_B256_56); 
	t=d[8]+c+s+(dchunk)(v[2]-v[6])*(md[6]-md[2])+(dchunk)(v[3]-v[5])*(md[5]-md[3]); a[1]=(chunk)t&BMASK_B256_56;  s-=dd[2]; c=(t>>BASEBITS_B256_56); 
	t=d[9]+c+s+(dchunk)(v[3]-v[6])*(md[6]-md[3])+(dchunk)(v[4]-v[5])*(md[5]-md[4]); a[2]=(chunk)t&BMASK_B256_56;  s-=dd[3]; c=(t>>BASEBITS_B256_56); 
	t=d[10]+c+s+(dchunk)(v[4]-v[6])*(md[6]-md[4]); a[3]=(chunk)t&BMASK_B256_56;  s-=dd[4]; c=(t>>BASEBITS_B256_56); 
	t=d[11]+c+s+(dchunk)(v[5]-v[6])*(md[6]-md[5]); a[4]=(chunk)t&BMASK_B256_56;  s-=dd[5]; c=(t>>BASEBITS_B256_56); 
	t=d[12]+c+s; a[5]=(chunk)t&BMASK_B256_56;  s-=dd[6]; c=(t>>BASEBITS_B256_56); 
	a[6]=d[13]+((chunk)c&BMASK_B256_56);
	...
	t += (dchunk)v[0] * md[1] ; v[1] = ((chunk)t * MC)&BMASK_B256_56; t += (dchunk)v[1] * md[0]; t = (t >> BASEBITS_B256_56) + d[2];
	t += (dchunk)v[0] * md[2] + (dchunk)v[1]*md[1]; v[2] = ((chunk)t * MC)&BMASK_B256_56; t += (dchunk)v[2] * md[0]; t = (t >> BASEBITS_B256_56) + d[3];
	t += (dchunk)v[0] * md[3] + (dchunk)v[1]*md[2]+ (dchunk)v[2]*md[1]; v[3] = ((chunk)t * MC)&BMASK_B256_56; t += (dchunk)v[3] * md[0]; t = (t >> BASEBITS_B256_56) + d[4];
	t += (dchunk)v[0] * md[4] + (dchunk)v[1]*md[3]+ (dchunk)v[2]*md[2]+ (dchunk)v[3]*md[1]; v[4] = ((chunk)t * MC)&BMASK_B256_56; t += (dchunk)v[4] * md[0]; t = (t >> BASEBITS_B256_56) + d[5];
	t += (dchunk)v[0] * md[5] + (dchunk)v[1]*md[4]+ (dchunk)v[2]*md[3]+ (dchunk)v[3]*md[2]+ (dchunk)v[4]*md[1]; v[5] = ((chunk)t * MC)&BMASK_B256_56; t += (dchunk)v[5] * md[0]; t = (t >> BASEBITS_B256_56) + d[6];
	t += (dchunk)v[0] * md[6] + (dchunk)v[1]*md[5]+ (dchunk)v[2]*md[4]+ (dchunk)v[3]*md[3]+ (dchunk)v[4]*md[2]+ (dchunk)v[5]*md[1]; v[6] = ((chunk)t * MC)&BMASK_B256_56; t += (dchunk)v[6] * md[0]; t = (t >> BASEBITS_B256_56) + d[7];
	t=t + (dchunk)v[1]*md[6] + (dchunk)v[2]*md[5] + (dchunk)v[3]*md[4] + (dchunk)v[4]*md[3] + (dchunk)v[5]*md[2] + (dchunk)v[6]*md[1] ; a[0] = (chunk)t & BMASK_B256_56; t = (t >> BASEBITS_B256_56) + d[8];
	t=t + (dchunk)v[2]*md[6] + (dchunk)v[3]*md[5] + (dchunk)v[4]*md[4] + (dchunk)v[5]*md[3] + (dchunk)v[6]*md[2] ; a[1] = (chunk)t & BMASK_B256_56; t = (t >> BASEBITS_B256_56) + d[9];
	t=t + (dchunk)v[3]*md[6] + (dchunk)v[4]*md[5] + (dchunk)v[5]*md[4] + (dchunk)v[6]*md[3] ; a[2] = (chunk)t & BMASK_B256_56; t = (t >> BASEBITS_B256_56) + d[10];
	t=t + (dchunk)v[4]*md[6] + (dchunk)v[5]*md[5] + (dchunk)v[6]*md[4] ; a[3] = (chunk)t & BMASK_B256_56; t = (t >> BASEBITS_B256_56) + d[11];
	t=t + (dchunk)v[5]*md[6] + (dchunk)v[6]*md[5] ; a[4] = (chunk)t & BMASK_B256_56; t = (t >> BASEBITS_B256_56) + d[12];
	t=t + (dchunk)v[6]*md[6] ; a[5] = (chunk)t & BMASK_B256_56; t = (t >> BASEBITS_B256_56) + d[13];
	a[6] = (chunk)t & BMASK_B256_56;
