...
int BLS12381::ECP_IN_RANGE(octet* S)
{
    BIG r,s;
...
int BLS12381::ECP_KEY_PAIR_GENERATE(csprng *RNG, octet* S, octet *W)
{
    BIG r, gx, gy, s;
    ECP G;
    int res = 0;
...
/* Validate public key */
int BLS12381::ECP_PUBLIC_KEY_VALIDATE(octet *W)
{
    BIG q, r, wx, k;
    ECP WP;
    int valid, nb;
...
int BLS12381::ECP_SVDP_DH(octet *S, octet *WD, octet *Z,int type)
{
    BIG r, s, wx;
    int valid;
    ECP W;
...
int BLS12381::ECP_SP_DSA(int hlen, csprng *RNG, octet *K, octet *S, octet *F, octet *C, octet *D)
{
    char h[128];
...
int BLS12381::ECP_VP_DSA(int hlen, octet *W, octet *F, octet *C, octet *D)
{
    char h[128];
    octet H = {0, sizeof(h), h};
...
void BLS12381::ECP_ECIES_ENCRYPT(int hlen, octet *P1, octet *P2, csprng *RNG, octet *W, octet *M, int tlen, octet *V, octet *C, octet *T)
{
...
int BLS12381::ECP_ECIES_DECRYPT(int hlen, octet *P1, octet *P2, octet *V, octet *C, octet *T, octet *U, octet *M)
{
