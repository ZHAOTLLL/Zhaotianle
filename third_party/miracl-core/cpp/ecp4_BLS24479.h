...
//    int inf; /**< Infinity Flag */
    BLS24479::FP4 x;   /**< x-coordinate of point */
    BLS24479::FP4 y;   /**< y-coordinate of point */
    BLS24479::FP4 z;   /**< z-coordinate of point */
} ECP4;
...
extern const B480_56::BIG CURVE_Bnx;   /**< Elliptic curve parameter */
 ...
 */
extern int ECP4_get(BLS24479::FP4 *x, BLS24479::FP4 *y, ECP4 *P);
 ...
 */
extern void ECP4_rhs(BLS24479::FP4 *r, BLS24479::FP4 *x);
 ...
 */
extern int ECP4_set(ECP4 *P, BLS24479::FP4 *x, BLS24479::FP4 *y);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP4_setx(ECP4 *P, BLS24479::FP4 *x, int s);
 ...
 */
extern void ECP4_mul(ECP4 *P, B480_56::BIG b);
 ...
 */
extern void ECP4_frob_constants(BLS24479::FP2 F[3]);
 ...
 */
extern void ECP4_frob(ECP4 *P, BLS24479::FP2 F[3], int n);
 ...
 */
extern void ECP4_mul8(ECP4 *P, ECP4 *Q, B480_56::BIG *b);
 ...
 */
extern void ECP4_map2point(ECP4 *Q, BLS24479::FP4 *x);
 ...
 */
extern void ECP4_hap2point(ECP4 *Q, B480_56::BIG  x);
