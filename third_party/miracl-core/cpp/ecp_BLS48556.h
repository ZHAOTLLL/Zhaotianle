...
extern const B560_58::BIG CURVE_HTPC2;  /**< Hash to Point precomputation for G2 */

extern const B560_58::BIG CURVE_Ad;
extern const B560_58::BIG CURVE_Bd;
extern const B560_58::BIG PC[];

extern const B560_58::BIG CURVE_Adr;
extern const B560_58::BIG CURVE_Adi;
extern const B560_58::BIG CURVE_Bdr;
extern const B560_58::BIG CURVE_Bdi;
extern const B560_58::BIG PCR[];
extern const B560_58::BIG PCI[];
...
extern const B560_58::BIG CURVE_Pxa; /**< real part of x-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pxb; /**< imaginary part of x-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pya; /**< real part of y-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pyb; /**< imaginary part of y-coordinate of generator point in group G2 */

/*** needed for BLS24 curves ***/

extern const B560_58::BIG CURVE_Pxaa; /**< real part of x-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pxab; /**< imaginary part of x-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pxba; /**< real part of x-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pxbb; /**< imaginary part of x-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pyaa; /**< real part of y-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pyab; /**< imaginary part of y-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pyba; /**< real part of y-coordinate of generator point in group G2 */
extern const B560_58::BIG CURVE_Pybb; /**< imaginary part of y-coordinate of generator point in group G2 */
...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    BLS48556::FP x; /**< x-coordinate of point */
#if CURVETYPE_BLS48556!=MONTGOMERY
    BLS48556::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    BLS48556::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(BLS48556::FP *r, BLS48556::FP *x);
 ...
 */
extern int ECP_setx(ECP *P, B560_58::BIG x, int s);
 ...
 */
extern int ECP_set(ECP *P, B560_58::BIG x);
 ...
 */
extern int ECP_get(B560_58::BIG x, ECP *P);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP_set(ECP *P, B560_58::BIG x, B560_58::BIG y);
 ...
 */
extern int ECP_get(B560_58::BIG x, B560_58::BIG y, ECP *P);
 ...
 */
extern void ECP_clmul(ECP *P, B560_58::BIG e, B560_58::BIG maxe);
 ...
 */
extern void ECP_mul(ECP *P, B560_58::BIG b);
 ...
 */
extern void ECP_mul2(ECP *P, ECP *Q, B560_58::BIG e, B560_58::BIG f);
 ...
 */
extern void ECP_clmul2(ECP *P, ECP *Q, B560_58::BIG e, B560_58::BIG f, B560_58::BIG maxe);
 ...
 */
extern void ECP_muln(ECP *P,int n,ECP X[],B560_58::BIG e[]);
 ...
 */
extern void ECP_map2point(ECP *Q, BLS48556::FP *x);
 ...
 *
	...
	@param x Fp derived from hash
 */
extern void ECP_hap2point(ECP *Q, B560_58::BIG  x);
