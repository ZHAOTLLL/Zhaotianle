...
{
    W->len = 12 * MODBYTES_B384_58;
    FP4_toBytes(&(W->val[0]),&(g->c));
    FP4_toBytes(&(W->val[4 * MODBYTES_B384_58]),&(g->b));
    FP4_toBytes(&(W->val[8 * MODBYTES_B384_58]),&(g->a));
}
...
void BLS12381::FP12_fromOctet(FP12 *g, octet *W)
{
    ...
    FP4_fromBytes(&(g->b),&(W->val[4 * MODBYTES_B384_58]));
    FP4_fromBytes(&(g->a),&(W->val[8 * MODBYTES_B384_58]));
