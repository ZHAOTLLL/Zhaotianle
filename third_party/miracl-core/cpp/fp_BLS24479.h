...
#include "big_B480_56.h"
#include "config_field_BLS24479.h"

using namespace core;

#define MODBITS_BLS24479 MBITS_BLS24479
#define TBITS_BLS24479 (MBITS_BLS24479%BASEBITS_B480_56)              /**< Number of active bits in top word */
#define TMASK_BLS24479 (((chunk)1<<TBITS_BLS24479)-1)             /**< Mask for active bits in top word */
#define FEXCESS_BLS24479 (((sign32)1<<MAXXES_BLS24479)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
...
typedef struct
{
    B480_56::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B480_56::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B480_56::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B480_56::BIG R2modp;	/**< Montgomery constant */
extern const chunk MConst;		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */
extern const B480_56::BIG SQRTm3;      /**< Square root of -3 */
extern const B480_56::BIG CRu;    /**< Cube Root of Unity */
//extern const int BTset;			/**< Set Bit in Generalised Mersenne */
extern const B480_56::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B480_56::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
extern const B480_56::BIG TWK; /**< Tweak for square roots, pre-calculated from field norm */
//#define FUSED_MODMUL
//#define DEBUG_REDUCE
 ...
 */
extern void FP_rcopy(FP *y, const B480_56::BIG x);
 ...
 */
extern void FP_mod(B480_56::BIG r, B480_56::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B480_56::BIG, B480_56::BIG, B480_56::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B480_56::BIG z);
