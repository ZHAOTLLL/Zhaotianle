...
#define MODBITS_BN254 MBITS_BN254
#define TBITS_BN254 (MBITS_BN254%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_BN254 (((chunk)1<<TBITS_BN254)-1)             /**< Mask for active bits in top word */
#define FEXCESS_BN254 (((sign32)1<<MAXXES_BN254)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
