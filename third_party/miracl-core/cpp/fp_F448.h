...
#include "big_B448_29.h"
#include "config_field_F448.h"

using namespace core;

#define MODBITS_F448 MBITS_F448
#define TBITS_F448 (MBITS_F448%BASEBITS_B448_29)              /**< Number of active bits in top word */
#define TMASK_F448 (((chunk)1<<TBITS_F448)-1)             /**< Mask for active bits in top word */
#define FEXCESS_F448 (((sign32)1<<MAXXES_F448)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
...
typedef struct
{
    B448_29::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B448_29::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B448_29::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B448_29::BIG R2modp;	/**< Montgomery constant */
extern const chunk MConst;		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */
extern const B448_29::BIG SQRTm3;      /**< Square root of -3 */
extern const B448_29::BIG CRu;    /**< Cube Root of Unity */
//extern const int BTset;			/**< Set Bit in Generalised Mersenne */
extern const B448_29::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B448_29::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
extern const B448_29::BIG TWK; /**< Tweak for square roots, pre-calculated from field norm */
//#define FUSED_MODMUL
//#define DEBUG_REDUCE
 ...
 */
extern void FP_rcopy(FP *y, const B448_29::BIG x);
 ...
 */
extern void FP_mod(B448_29::BIG r, B448_29::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B448_29::BIG, B448_29::BIG, B448_29::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B448_29::BIG z);
