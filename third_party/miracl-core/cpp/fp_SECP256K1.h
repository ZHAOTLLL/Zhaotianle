...
#define TBITS_SECP256K1 (MBITS_SECP256K1%BASEBITS_B256_28)              /**< Number of active bits in top word */
...
typedef struct
{
    B256_28::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B256_28::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B256_28::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B256_28::BIG R2modp;	/**< Montgomery constant */
extern const chunk MConst;		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */
extern const B256_28::BIG SQRTm3;      /**< Square root of -3 */
extern const B256_28::BIG CRu;    /**< Cube Root of Unity */
//extern const int BTset;			/**< Set Bit in Generalised Mersenne */
extern const B256_28::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B256_28::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
extern const B256_28::BIG TWK; /**< Tweak for square roots, pre-calculated from field norm */
//#define FUSED_MODMUL
//#define DEBUG_REDUCE
 ...
 */
extern void FP_rcopy(FP *y, const B256_28::BIG x);
 ...
 */
extern void FP_mod(B256_28::BIG r, B256_28::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B256_28::BIG, B256_28::BIG, B256_28::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B256_28::BIG z);
