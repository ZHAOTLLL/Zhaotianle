...
#define RFS_RSA3072 MODBYTES_B384_28*FFLEN_RSA3072 /**< RSA Public Key Size in bytes */
...
typedef struct
{
    ...
    B384_28::BIG n[FFLEN_RSA3072]; /**< An array of BIGs to store public key */
} rsa_public_key;
...
typedef struct
{
    B384_28::BIG p[FFLEN_RSA3072 / 2]; /**< secret prime p  */
    B384_28::BIG q[FFLEN_RSA3072 / 2]; /**< secret prime q  */
    B384_28::BIG dp[FFLEN_RSA3072 / 2]; /**< decrypting exponent mod (p-1)  */
    B384_28::BIG dq[FFLEN_RSA3072 / 2]; /**< decrypting exponent mod (q-1)  */
    B384_28::BIG c[FFLEN_RSA3072 / 2]; /**< 1/p mod q */
} rsa_private_key;
